...
export const FILE_PATTERNS = {
  ...
  ANDROID_APP_BUILD_GRADLE: "**/android/app/build.gradle",
  ANDROID_APP_BUILD_GRADLE_KTS: "**/android/app/build.gradle.kts",
  ...
  ANDROID_SETTINGS_GRADLE_KTS: "**/android/settings.gradle.kts",
  ANDROID_GRADLE_WRAPPER: "**/android/gradle/wrapper/gradle-wrapper.properties",
